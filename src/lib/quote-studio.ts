...
export const quoteTemplateItems: QuoteTemplateItem[] = [
  {
    ...
    name: "基礎保護工程",
    unit: "式",
    pricingBasis: "依案場規模與公共區保護動線計，預設涵蓋 20 公尺內",
    defaultUnitPrice: 12000,
    defaultQuantity: 1,
    description: "含施工前地坪、電梯與公共區保護；若社區要求雙層夾板、特殊防護材或動線超過 20 公尺，將另行評估。",
  },
  {
    id: "demolition-basic",
    categoryId: "preparation",
  ...
  },
  {
    ...
    defaultQuantity: 1,
    description: "含櫃內外擦拭、窗溝去污、地坪細清與交屋前整體除塵；不含高危險外窗外側清潔、大型家具搬移與非本案造成之重度殘膠或漆面處理。",
  },
  {
  ...
  },
  {
    ...
    defaultQuantity: 1,
    description: "含室內外機吊掛、標準銅管銜接、基礎測試與一般隔間牆洗洞一孔；不含樑柱、剪力牆等主結構體洗洞，特殊高空作業或危險施工另計。",
  },
  {
  ...
  },
  {
    ...
    name: "系統櫃五金 / 收納配件升級",
    unit: "項",
    pricingBasis: "依抽屜滑軌、拉籃、吊衣桿、分隔件與特殊五金之單一選配項目計",
    defaultUnitPrice: 6500,
    defaultQuantity: 1,
    description: "適用系統櫃之抽屜、拉籃、特殊鉸鏈與收納配件升級；建議搭配五金配件確認清單逐項列示與計價。",
  },
  {
    id: "woodwork-cabinet",
    categoryId: "cabinet",
...
export const quoteDefaultTerms = [
  ...
  "若遇大樓管委會特殊規定、無電梯搬運、夜間施工、高規格公共區保護、額外清運或每日清潔要求，將另行評估並說明；基礎保護工程以公共區保護動線 20 公尺內為估價前提，超長或特殊防護材另計。",
